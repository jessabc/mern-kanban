...
const Login = () => {
  ...
  return (
        ...
        <div class="p-4 sm:p-7">
          <div class="text-center">
            ...
            <p class="mt-2 text-sm text-gray-600 dark:text-neutral-400">
              ...
              <Link
                class="text-indigo-500 decoration-2 hover:underline font-medium "
                to="/signup"
              >
                Sign up here
              </Link>
    ...
    //         <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} className='bg-zinc-100 rounded-sm outline-1 outline-zinc-500 p-2'/>

    //         <label htmlFor="">Password</label>
    //         <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} className='bg-zinc-100 rounded-sm outline-1 outline-zinc-500 p-2'/>

    //         <button disabled={loading} className='font-bold bg-zinc-800 text-zinc-100 rounded-lg p-3 hover:bg-zinc-700 my-2'>Login</button>
